...
def test_report_total_revenue():
    report_data = ReportData(
        [{"prijs": Decimal("100.50")}, {"prijs": Decimal("200.80")}]
    )
...
def test_report_calculate_price_per_column_item():
    report_data = ReportData(
        [
            {"product": "banana", "prijs": Decimal("100.50")},
            {"product": "banana", "prijs": Decimal("200.50")},
...
def test_report_calculate_top():
    report_data = ReportData(
        [
            {"klant": "Maria", "prijs": Decimal("150.40")},
            {"klant": "Anna", "prijs": Decimal("301.00")},
